function uc = GetUnicodeChar(character)
    ...
    arguments
        character {mustBeMember(character, {'Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta', 'Theta', 'Iota', 'Kappa','Lambda',...
             ...
             'EmptyCircle', 'FilledCircle', 'UpTriangle', 'Intersection', 'Union', 'all'})} 
    end
    ...
    names = {'Alpha', 'Beta', 'Gamma', 'Delta', 'Epsilon', 'Zeta', 'Eta', 'Theta', 'Iota', 'Kappa','Lambda',...
             ...
             'mu', 'nu', 'xi', 'omicron', 'pi', 'rho', 'sigma', 'tau', 'upsilon', 'phi', 'chi', 'psi', 'omega',...
             'degree', 'Degree', 'LeftArrow', 'UpArrow', 'RightArrow', 'DownArrow', 'HBar', 'EMDash3', 'PlusMinus',...
             'EmptyCircle', 'FilledCircle', 'UpTriangle', 'Intersection', 'Union'}; % Update the argument list above for linting
