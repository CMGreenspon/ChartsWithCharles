    ...
    switch lower(options.distribution_style) % Because switch has no case-invariant mode
        case 'box'
            ...
            if options.error_whiskers
                plot([x,x], [max(y_error), prctile(y, options.error_percentiles(4))],...
                    'Color' , [options.distribution_color, options.distribution_line_alpha], ...
                    'LineWidth', options.distribution_line_width, 'parent', options.parent, 'Marker', 'none')
                plot([x-options.distribution_width*options.distribution_whisker_ratio,x+options.distribution_width*options.distribution_whisker_ratio],...
                    prctile(y, options.error_percentiles([4,4])), 'Color' , [options.distribution_color, options.distribution_line_alpha], ...
                    'LineWidth', options.distribution_line_width, 'parent', options.parent, 'Marker', 'none')
                plot([x,x], [min(y_error), prctile(y, options.error_percentiles(1))],...
                    'Color' , [options.distribution_color, options.distribution_line_alpha], 'LineWidth', ...
                    options.distribution_line_width, 'parent', options.parent, 'Marker', 'none')
                plot([x-options.distribution_width*options.distribution_whisker_ratio,x+options.distribution_width*options.distribution_whisker_ratio],...
                    prctile(y, options.error_percentiles([1,1])), 'Color' , [options.distribution_color, options.distribution_line_alpha], ...
                    'LineWidth', options.distribution_line_width, 'parent', options.parent, 'Marker', 'none')
            end
